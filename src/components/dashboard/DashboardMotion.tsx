...
export default function DashboardMotion(props: DashboardServiceProps) {
    ...
    return (
        <OptionalTooltip
            title={!server ? "Use the physical motion sensor!" : undefined}
        >
            <SvgWidget
                title={title}
                tabIndex={0}
