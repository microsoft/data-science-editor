...
-   it has a [Jacdac edge connector](https://github.com/microsoft/jacdac-ddk/tree/main/connector) for joining the device to the Jacdac bus
    using [Jacdac cables](https://github.com/microsoft/jacdac-ddk/tree/main/connector#cable);
-   it implements the [Jacdac protocol](/reference/protocol/) to communicate over the bus via the connector;
-   it follows the [design guidelines](https://github.com/microsoft/jacdac-ddk/tree/main/design) in this DDK.
...
1. choosing on-board components and incorporating them in a [hardware design](https://github.com/microsoft/jacdac-ddk/tree/main/design);
