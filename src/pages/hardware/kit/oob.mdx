...
-   When a Jacdac mouse and a joystick are connected, the joystick will move the mouse.
-   When a Jacdac mouse and a button are connected, the button will trigger mouse left-button clicks.
