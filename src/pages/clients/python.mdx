...
The transport used to connect to the Jacdac device
typically varies a lot dependending on the platform and the usage scenario.
This layer currently supports a cross-platform development mode using browser bridge
and a transport for the Raspberry Pi using a specialized Jacdapter.
