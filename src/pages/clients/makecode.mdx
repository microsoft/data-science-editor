...
The [pxt-jacdac](https://github.com/microsoft/pxt-jacdac) extension contains MakeCode support for many Jacdac services.
Each Jacdac service is represented by a separate MakeCode [extension](./makecode/extensions) within
the [pxt-jacdac repository](https://github.com/microsoft/pxt-jacdac);
MakeCode knows which services a Jacdac module (physical or simulated) supports to help you get started quickly.
