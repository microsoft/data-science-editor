...
You can start simulators for any Jacdac service. This is useful if you do not have the hardware module or you want to simulate specific condition... like freezing temperatures! For example, to **start a button simulator**,
