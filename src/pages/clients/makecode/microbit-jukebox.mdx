...
Whenever Jacdac detects a new device, it mounts clients for each known services with a predefined set of behaviors. It is [programmed in MakeCode](https://github.com/microsoft/pxt-jacdac/tree/master/tools/microbit-jukebox).
