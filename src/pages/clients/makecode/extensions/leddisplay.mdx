...
input.onButtonPressed(Button.A, () => {
    modules.ledDisplay1.setAll(0x00ff00)
})
input.onButtonPressed(Button.B, () => {
    modules.ledDisplay1.setAll(0xff0000)
})
```
...
input.onButtonPressed(Button.A, () => {
    ...
    let n = modules.ledDisplay1.numPixels()
    for(let i = 0; i <= n - 1; i++) {
        modules.ledDisplay1.setPixel(i, 0x00ff00)
        basic.pause(200)
    }
})
```
...
-   [service specification](/services/leddisplay/)
