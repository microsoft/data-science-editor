...
The module that implements the HID keyboard server, like the [JD BRAIN F4](/devices/microsoft/research/jmbrainf441v02) 
must also be connected with a USB-C cable to your computer.

![A microbit and HID keyboard module connected with 2 cables](./hidkeyboard/cables.jpeg)
