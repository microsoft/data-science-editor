...
The **[Out of the box program](/clients/makecode/microbit-jukebox/)** is a Jacdac program
...
![Animation of a button connected to the micro:bit V2](/clients/makecode/microbit-jukebox.gif)
...
Before starting these steps, please make sure your **micro:bit V2** is connected to your computer using a USB cable. Please also ensure your micro:bit is running [the out of box firmware](/clients/makecode/microbit-jukebox/)!
