...
<iframe src="https://jacdac-aframe-demo.glitch.me" style="border: none;" width="480" height="320" allow="usb;serial;bluetooth;vr" />
...
```html
<button id="connectbtn" style="position:absolute; left: 1rem; top: 1rem; z-index:1000;">jacdac connect</button>    
```
