...
To use the [hooks](/clients/javascript/react/hooks/) in this library, you must wrap your top-level component with the `JacdacProvider` which installs the `JacdacContext` in the React tree.
...
With the context in place, your React application is ready to use the [Jacdac hooks](/clients/javascript/react/hooks/).
