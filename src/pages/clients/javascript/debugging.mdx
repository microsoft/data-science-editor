...
The device tree (on the left) allows to explore the JDOM tree: device, services, registers, events.
The value of each register and also count events being triggered.

## Packet Console

The packet console, available from the device tree, lets you investigate, filter packet traces.
