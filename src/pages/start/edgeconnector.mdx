---
title: Hubs and edge connectors
order: 20
---

## Hubs and Edge Connectors

![Hub with 8 Jacdac edge connectors](./hubv10.jpg)

Most Jacdac devices have at least one edge connector, which is the 
tab with three metal fingers integrated into the device's printed circuit board (PCB). 
...
![A rendering of a Jacdac cable connecting both ways.](./reversibleconnectoranimation.gif)
