...
-   import your repository url **with /jacdac** appended. This will create a new extension in the same repository. MakeCode will ask you to confirm to create a subfolder, accep

    t

> If you repo is `https://github.com/company/pxt-thing/`, import `https://github.com/company/pxt-thing/jacdac`
...
-   once the simulator, the Jacdac dashboard will show up under the micro:bit
-   start simulators for the [services](https://microsoft.github.io/jacdac-docs/services/) you want to support
-   click on the `Add Blocks` button and import all the necessary extension to support those simulators
...
### Step 3: Register accessory and update device identifier
