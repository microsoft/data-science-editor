...
Refer to the [DDK](/ddk) for specific information about manufacturing Jacdac devices.
...
To take the photo with the correct perspective, you might want to print out and cut out this template, and hold it over the preview image on the camera. This makes it easier to adjust the tilt of the camera to make photos consistent. 
