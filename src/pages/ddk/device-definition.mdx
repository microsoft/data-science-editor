...
To take the photo with the correct perspective, you might want to print out and cut out the template in [these instructions](./jacdac-device-photo-template.pdf). This makes it easier to adjust the tilt of the camera to make photos consistent. 
