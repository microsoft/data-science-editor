...
## Software-only Jacdac for existing accessories
...
## Adding a Jacdac connector for a power-consuming accessory
...
## Adding a Jacdac connector for a power-providing accessory
