...
The Jacdac team provides firmware for extreme low cast MCUs like the [PADAIK](https://github.com/microsoft/jacdac-padauk) to reduce the cost impact. Follow the [hardware design guidance](/ddk/design/) for this option.
