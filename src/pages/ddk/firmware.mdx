...
We provide the following open source repositories which help you build firmware for your Jacdac modules.
...
-   [.NET](/clients/dotnet)
-   [MakeCode Extension](https://github.com/microsoft/pxt-jacdac) which works with various MakeCode editors:
