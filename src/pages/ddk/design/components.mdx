...
This page presents some information about part selection for some of the key components of many Jacdac devices. For some components we provide [specific part numbers](https://github.com/microsoft/jacdac-ddk/tree/main/electronics/generic/suggested-components).
