...
is nominally 3.3V and a logical zero is nominally 0V. The full spec of the signalling voltage is provided [here](https:///reference/electrical-spec/#all-devices).
