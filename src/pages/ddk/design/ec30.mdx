...
and mechanical accessories, we recommend the use of the EC30---enclosure-compatible with 3.0mm mounting holes---module form factor.
...
Mounting holes have a finished diameter of 3.1mm, with a 4.4mm diameter annular ring, and a solder resist keepout of 5.0mm diameter.  **TODO: Outside layers routing keepout**
