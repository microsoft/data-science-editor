...
2. define (identify/create) the [services](./services) to represent the chosen components;
...
Jacdac is designed to interoperate with many other tools and platforms. The physical and electrical requirements of Jacdac can be provided via a [Jacdaptor](/start/jacdaptors/) (Jadcac adaptor); the detailed requirements for building a Jacdaptor vary depending on the platform it's designed to work with. 
