...
-   **[Get It Now](https://appsource.microsoft.com/en-us/product/office/WA200005186)**

![A data analysis program](./hero.png)

## Getting started

-   Download the **[Getting Started DataSet Sheet](https://microsoft.github.io/data-science-editor-excel/hosted_files/data-science-editor-datasets.xlsx)** to get started with data
-   Click **Get Addin** and search **Data Science Editor**, add this addin to your workspace.
