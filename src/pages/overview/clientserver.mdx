...
- this [micro:bit-as-client program](https://github.com/microsoft/pxt-jacdac/tree/master/tools/microbit-jukebox) programs the micro:bit V2 to listen for external Jacdac modules joining or leaving the Jacdac bus, and responds in a variety of ways
