...
A Jacdac [device](/devices) is any device that exposes the [Jacdac PCB edge connector](/ddk/design#pcb-edge-connector)
...
Jacdac devices with a [Jacdac PCB edge connector](/ddk/design#pcb-edge-connector)
