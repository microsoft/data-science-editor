...
title: LED Status
order: 4
description: What the LED status color/pattern means
---
...
When the brain connects the device to its role manager, the device will blink green twice
quickly three times ( ((96ms on, 192ms off) * 2 + 320ms off) * 4).
